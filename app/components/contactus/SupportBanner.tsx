  ...
  return (
    <>
        <section className="support-page-banner">
            <div className="support-page-container container relative bg-[url('/Banners/support-banner.jpg')] bg-cover bg-center bg-no-repeat">
                <div className="support-content-container container-small">
